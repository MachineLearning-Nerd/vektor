...
|---|---|---|---|---|
| 3.1 | [`Embedder` trait — async, `embed/dim/name/prefix_for_document/prefix_for_query`](01-embedder-trait.md) | S | 2.9 | ⬜ |
...
| 3.6 | [`VectorStore::new(project_dir, dim)` — LanceDB connect, create table with Arrow schema from PRD Section 4.10](06-vector-store-new.md) | M | 2.9 | ⬜ |
...
- [ ] All 14 task files above marked ✅ Done
